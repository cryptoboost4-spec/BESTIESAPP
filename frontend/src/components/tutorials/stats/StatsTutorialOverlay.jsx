 ...
 * Stats Tutorial
 *
 * Guides users through the new relationship stats
 * Highlights "Your Relationships" section and Strongest Connection
 */

const TUTORIAL_STEPS = {
  STEP_1: 1, // Highlight "Your Relationships" section
  STEP_2: 2, // Highlight "Strongest Connection"
};

const StatsTutorialOverlay = ({ isActive, onComplete }) => {
  ...
  const handleComplete = () => {
    ...
    setTimeout(() => {
      localStorage.setItem('statsTutorialSeen', 'true');
      if (onComplete) {
        onComplete();
      }
    }, 1000);
...
const TutorialTooltip = ({ step, onNext, onSkip }) => {
  const content = {
    [TUTORIAL_STEPS.STEP_1]: {
      ...
      text: "Track what you build together - messages, support actions, challenges. See how your connections grow over time!",
      btn: "Cool!"
    },
    [TUTORIAL_STEPS.STEP_2]: {
      icon: "⚡",
      title: "Strongest Connection",
      text: "This shows your most active bestie relationship based on how you support each other. Keep connecting to grow this score!",
      btn: "Awesome!"
    },
  }[step];
...
export default StatsTutorialOverlay;
