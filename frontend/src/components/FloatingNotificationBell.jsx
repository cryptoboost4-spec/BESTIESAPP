...
const FloatingNotificationBell = ({ inline = false }) => {
  ...
  // Inline mode - simple icon for embedding in headers
  if (inline) {
    return (
      <div className="relative" ref={dropdownRef}>
        ...
        >
          ...
          >
            <defs>
              <linearGradient id="bellGradientInline" x1="0%" y1="0%" x2="100%" y2="100%">
        ...
        {/* Dropdown - same as floating version */}
        {showDropdown && (
