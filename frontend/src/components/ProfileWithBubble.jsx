    ...
    <div className={`relative inline-block ${className}`}>
      ...
      {shouldShowBubble && (
        <div className="absolute -top-2 -right-2 z-10 animate-bounce-slow max-w-[calc(100vw-4rem)] sm:max-w-none">
          {/* Speech bubble */}
          <div className={`bg-purple-500 text-white rounded-full ${bubbleSize} font-semibold shadow-lg relative`} style={{ maxWidth: 'min(200px, calc(100vw - 2rem))', whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis' }}>
            <span className="block truncate">{requestAttention.tag}</span>
