  ...
  return (
    <div className="fixed inset-0 bg-black/60 dark:bg-black/75 flex items-center justify-center z-50 p-4 backdrop-blur-sm" onClick={onClose}>
      <div className="card max-w-lg w-full p-0 animate-scale-up overflow-hidden relative bg-gradient-to-br from-pink-50 via-purple-50 to-pink-50 dark:from-pink-900/20 dark:via-purple-900/20 dark:to-pink-900/20 border-2 border-pink-200 dark:border-pink-600 shadow-2xl" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="bg-gradient-to-r from-primary via-purple-500 to-pink-500 p-8 text-center relative overflow-hidden">
          {/* Decorative circles */}
          ...
          <div className="relative z-10">
            ...
            <h3 className="text-3xl font-display text-white mb-2 drop-shadow-lg">
              Complete Your Circle!
            </h3>
            <div className="inline-block bg-white/20 backdrop-blur-sm px-4 py-2 rounded-full">
              <p className="text-white font-semibold">
                <span className="text-2xl font-display">{circleCount}</span>
                <span className="text-white/80"> / </span>
                <span className="text-2xl font-display">5</span>
                <span className="text-sm ml-2">besties</span>
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="p-6">
          {/* Info Box */}
          <div className="bg-white dark:bg-gray-800 rounded-2xl p-5 mb-6 shadow-lg border-2 border-pink-100 dark:border-pink-800">
            <div className="flex items-start gap-3">
              <div className="text-3xl flex-shrink-0">🛡️</div>
              <div>
                <h4 className="font-display text-lg text-primary dark:text-purple-400 mb-2">
          ...
          {/* Social Sharing */}
          <div className="mb-6">
            <h4 className="text-lg font-display text-center text-primary dark:text-purple-400 mb-4">
              ✨ Invite Friends to Join You ✨
            </h4>
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
              <button
                onClick={() => handleShare('whatsapp')}
                className="flex flex-col items-center gap-2 p-4 rounded-xl bg-[#25D366] hover:bg-[#20BA5A] text-white transition-all hover:scale-105 shadow-md"
              ...
              <button
                ...
                className="flex flex-col items-center gap-2 p-4 rounded-xl bg-[#0084FF] hover:bg-[#0073E6] text-white transition-all hover:scale-105 shadow-md"
              ...
              <button
                ...
                className="flex flex-col items-center gap-2 p-4 rounded-xl bg-gradient-to-r from-[#833AB4] via-[#FD1D1D] to-[#F77737] hover:opacity-90 text-white transition-all hover:scale-105 shadow-md"
              ...
              <button
                ...
                className="flex flex-col items-center gap-2 p-4 rounded-xl bg-success hover:bg-green-600 text-white transition-all hover:scale-105 shadow-md"
                title="Share via SMS"
              >
              ...
              <button
                ...
                className="flex flex-col items-center gap-2 p-4 rounded-xl bg-[#1877F2] hover:bg-[#166FE5] text-white transition-all hover:scale-105 shadow-md"
              ...
              <button
                onClick={onClose}
                className="flex flex-col items-center gap-2 p-4 rounded-xl bg-gray-200 dark:bg-gray-700 hover:bg-gray-300 dark:hover:bg-gray-600 text-gray-800 dark:text-gray-200 transition-all hover:scale-105 shadow-md"
              >
                <div className="w-10 h-10 flex items-center justify-center text-2xl">👋</div>
                <span className="text-sm font-semibold">Maybe Later</span>
              </button>
            </div>
          </div>
