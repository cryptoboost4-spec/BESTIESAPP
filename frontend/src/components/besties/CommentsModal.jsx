...
const CommentsModal = ({
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 z-[9999] flex items-center justify-center pb-24">
      <div className="bg-white dark:bg-gray-800 rounded-2xl max-w-md w-full max-h-[70vh] flex flex-col">
        {/* Header */}
